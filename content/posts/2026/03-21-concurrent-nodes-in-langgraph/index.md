...
![LangGraph concurrent nodes fanning out from START and fanning back in on END](graph1.png)
...
![LangGraph concurrent nodes arranged with a reducer and brief writer](graph2.png)
